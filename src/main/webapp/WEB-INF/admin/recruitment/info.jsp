        ...
        <div class="px-4" style="display:flex; flex-direction:column; width: 100%; height:100%;">
            ...
            <table class="table mt-4 align-middle text-leftl border-top">
                ...
                <tr>
                    ...
                    <td style="width: 80%;">
                        <p><fmt:formatDate pattern="HH:mm" value="${ parseTheaterStartDatetime }"/> ~ <fmt:formatDate pattern="HH:mm" value="${ parseTheaterEndDatetime }"/></p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <c:choose>
                            <c:when test="${recruitment.content.recruitmentStatus == 'CONFIRMATION'}">
                                <input class="form-check-input" type="radio" value="CONFIRMATION" name="recruitmentStatus"
            ...
            <div style="display:flex; width: 100%; height:60px">
                ...
                <div style="display:flex; width: 100%; height:40px; justify-content:flex-end">
                    <button type="button" class="btn btn-success me-3" onclick="saveRecruitment()">&nbsp;수정&nbsp;</button>
